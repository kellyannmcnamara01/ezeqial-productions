...
function(e){"use strict";e.extend(e.fn.cycle.defaults,{tmplRegex:"{{((.)?.*?)}}"}),e.extend(e.fn.cycle.API,{tmpl:function(t,n){var i=new RegExp(n.tmplRegex||e.fn.cycle.defaults.tmplRegex,"g"),r=e.makeArray(arguments);return r.shift(),t.replace(i,function(t,n){var i,o,a,s,l=n.split(".");for(i=0;i<r.length;i++)if(a=r[i]){if(l.length>1)for(s=a,o=0;o<l.length;o++)a=s,s=s[l[o]]||n;else s=a[n];if(e.isFunction(s))return s.apply(a,r);if(void 0!==s&&null!==s&&s!=n)return s}return n})}})}(jQuery),window.addEventListener("load",function(){$(".accordion__trigger").click(function(){var e=$(this).attr("aria-controls"),t=($(this).attr("id"),$('.accordion-panel[id="'+e+'"]'));$(".accordion__trigger").attr("aria-expanded",!1),$(this).attr("aria-expanded",!0),$(".accordion-panel").attr("hidden",!0),t.attr("hidden",!1),window.location.hash=e,$("html, body").animate({scrollTop:$(this).offset().top-100},1e3)}),tallestEleHeight=0,$(".production-card__info").each(function(){var e=$(this).height();e>tallestEleHeight&&(tallestEleHeight=e),$(this).height(tallestEleHeight)})});
