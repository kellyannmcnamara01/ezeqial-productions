...
function(e){"use strict";e.extend(e.fn.cycle.defaults,{tmplRegex:"{{((.)?.*?)}}"}),e.extend(e.fn.cycle.API,{tmpl:function(t,n){var i=new RegExp(n.tmplRegex||e.fn.cycle.defaults.tmplRegex,"g"),r=e.makeArray(arguments);return r.shift(),t.replace(i,function(t,n){var i,o,a,s,l=n.split(".");for(i=0;i<r.length;i++)if(a=r[i]){if(l.length>1)for(s=a,o=0;o<l.length;o++)a=s,s=s[l[o]]||n;else s=a[n];if(e.isFunction(s))return s.apply(a,r);if(void 0!==s&&null!==s&&s!=n)return s}return n})}})}(jQuery),window.addEventListener("load",function(){function e(){$(window).scrollTop()>=25?$(".js--main-nav").addClass("is-scrolled"):$(".js--main-nav").removeClass("is-scrolled")}var t;$(window).bind("scroll",function(){t||(t=setTimeout(function(){e(),t=null},75))}),e(),$(".accordion__trigger").click(function(){var e=$(this).attr("aria-controls"),t=($(this).attr("id"),$('.accordion-panel[id="'+e+'"]'));window.location.hash=e,"false"==$(this).attr("aria-expanded")?($(".accordion__trigger").attr("aria-expanded","false"),$(".accordion-panel").attr("aria-expanded","false"),$(".accordion-panel").slideUp(),$(this).attr("aria-expanded","true"),t.attr("aria-expanded","true"),t.slideDown()):($(this).attr("aria-expanded","false"),t.attr("aria-expanded","false"),t.slideUp())}),tallestEleHeight=0,$(".production-card__info").each(function(){var e=$(this).height();e>tallestEleHeight&&(tallestEleHeight=e),$(this).height(tallestEleHeight)}),$(".hamham").click(function(){var e=$(this).attr("aria-expanded");console.log(e),"true"==e?($(this).attr("aria-expanded","false"),$(".mobile-nav").fadeOut()):($(this).attr("aria-expanded","true"),$(".mobile-nav").fadeIn())})});
